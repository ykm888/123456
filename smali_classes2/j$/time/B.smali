...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/B;->a:Ljava/util/Map;
...
.method public static E(Ljava/lang/String;Ljava/util/Map;)Lj$/time/B;
    .locals 1
...
.method static F(Ljava/lang/String;Z)Lj$/time/B;
    .locals 2
    ...
    :goto_0
    invoke-static {p0, v0, p1}, Lj$/time/B;->H(Ljava/lang/String;IZ)Lj$/time/B;
    ...
    :cond_2
    invoke-static {p0, p1}, Lj$/time/D;->J(Ljava/lang/String;Z)Lj$/time/D;
    ...
    :cond_4
    :goto_2
    invoke-static {p0}, Lj$/time/C;->L(Ljava/lang/String;)Lj$/time/C;
...
.method public static G(Ljava/lang/String;Lj$/time/C;)Lj$/time/B;
    .locals 2
    ...
    invoke-virtual {p1}, Lj$/time/C;->j()Ljava/lang/String;
    ...
    .line 4
    invoke-direct {v0, p0, p1}, Lj$/time/D;-><init>(Ljava/lang/String;Lj$/time/zone/e;)V

    return-object v0
.end method

.method private static H(Ljava/lang/String;IZ)Lj$/time/B;
    .locals 3
    ...
    sget-object p0, Lj$/time/C;->f:Lj$/time/C;

    invoke-static {v0, p0}, Lj$/time/B;->G(Ljava/lang/String;Lj$/time/C;)Lj$/time/B;
    ...
    invoke-static {p0, p2}, Lj$/time/D;->J(Ljava/lang/String;Z)Lj$/time/D;
    ...
    invoke-static {p1}, Lj$/time/C;->L(Ljava/lang/String;)Lj$/time/C;

    move-result-object p1

    sget-object p2, Lj$/time/C;->f:Lj$/time/C;

    if-ne p1, p2, :cond_2

    invoke-static {v0, p1}, Lj$/time/B;->G(Ljava/lang/String;Lj$/time/C;)Lj$/time/B;
